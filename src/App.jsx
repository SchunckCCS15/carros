    ...
    <main className= "min-h-svh bg-offwhitebg py-20 px-6 antialiased lg:flex justify-center items-center" >
      ...
      <section className= "lg:flex" >
        ...
        <div className= "bg-orange p-12 rounded-t-lg" >
          ...
          <a className= "font-lexend bg-offwhitebg text-orange block rounded-3xl px-10 py-3 w-fit" href= "https://www.webmotors.com.br/sedans" target="_blanck" >Ver mais</a>
        ...
        <div className= "bg-green p-12" >
          ...
          <a className= "font-lexend bg-offwhitebg text-green block rounded-3xl px-10 py-3 w-fit" href="https://www.webmotors.com.br/suvs" target="_blanck" >Ver mais</a>
        ...
        <div className= "bg-dark-green p-12 rounded-b-lg" >
          ...
          <a className= "font-lexend bg-offwhitebg text-dark-green block rounded-3xl px-10 py-3 w-fit" href="https://www.webmotors.com.br/carros-de-luxo" target="_blanck" >Ver mais</a>
